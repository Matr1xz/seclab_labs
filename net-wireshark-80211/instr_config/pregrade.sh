...
# Chuan hoa dap an sinh vien: SSID trong Wireshark hien thi dang "linksys_SES_24086"
# (dau gach duoi) nen chap nhan ca cach go co gach duoi lan cach go co dau cach.
sed -i '/SSIDs *=/ s/_/ /g' 802_11_answer.txt
