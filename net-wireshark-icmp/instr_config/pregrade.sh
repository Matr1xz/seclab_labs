...
# Chuan hoa dap an sinh vien: dam bao dung MOT dau cach sau nhan truoc khi cham,
# de ca "nhan:gia_tri" va "nhan: gia_tri" deu duoc chap nhan.
sed -i -E 's/^(Packet number|Source|Destination|Type number|Code number|Checksum|Sequence Number\(BE\)|Identifier\(BE\)|Answer):[ \t]*/\1: /' icmp-qna
